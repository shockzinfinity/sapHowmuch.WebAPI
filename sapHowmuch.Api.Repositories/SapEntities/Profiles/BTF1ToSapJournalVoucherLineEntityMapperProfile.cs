...
{
	public class BTF1ToSapJournalVoucherLineEntityMapperProfile : Profile
	{
		public BTF1ToSapJournalVoucherLineEntityMapperProfile()
		{
			CreateMap<BTF1, SapJournalVoucherLineEntity>()
