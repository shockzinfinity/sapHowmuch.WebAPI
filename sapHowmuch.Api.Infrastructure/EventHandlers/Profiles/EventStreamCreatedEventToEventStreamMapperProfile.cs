...
{
	public class EventStreamCreatedEventToEventStreamMapperProfile : Profile
	{
		public EventStreamCreatedEventToEventStreamMapperProfile()
		{
			CreateMap<EventStreamCreatedEvent, EventStream>()
